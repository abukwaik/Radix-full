...
class rookie_flickr_photos extends WP_Widget {

	function rookie_flickr_photos() {
		$widget_ops = array( 'classname' => 'flickr-widget' );
		$control_ops = array( 'width' => 200, 'height' => 300, 'id_base' => 'flickr_photos-widget' );
	...
	function form( $instance ) {
		$defaults = array( 'title' =>__( 'Flickr' , 'rookie'), 'no_of_photos' => '6' , 'flickr_display' => 'latest' );
		...
		<p>
			...
			<small> Find Your ID at <a href="<?php echo esc_url( __('http://www.idgettr.com', 'rookie'));?>" target="_blank">idGettr</a></small>
		</p>
		<p>
...
function reg_flickr_photos_widget() {
	register_widget( 'rookie_flickr_photos' );
}
add_action( 'widgets_init', 'reg_flickr_photos_widget' );